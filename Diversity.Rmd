...
deprivation <-read.xlsx("File_4_ID_2015_Sub-domains_of_deprivation.xlsx")

```

open 2001 ethnivity tables
```{r}

download.file("http://neighbourhood.statistics.gov.uk/dissemination/DownloadData.zip", "test.zip")

#unzip folder
con <- unz(description="DownloadData.zip", filename="UV090301_88_GeoPolicy_UK_LSOA.txt")
dir.create("Census2001")
setwd("./Census2001")
